...
public class MarkServiceImpl implements IMarkService {
    ...
    @Override
    public Page<Mark> search(Pageable pageable, String nameStudent, Integer subjectId, Integer classId) {
        return iMarkRepository.findAllStudentByName(pageable, nameStudent, subjectId, classId);
    }
}